...
!(function (e, t) {
  ...
  function E() {
    return (ze && ze.isPressed) || a.cache++;
  }
  function F(t) {
    return function (e) {
      return (
        e || 0 === e
          ? (r && (ke.history.scrollRestoration = "manual"),
            t(e),
            (t.v = e),
            (t.c = a.cache),
            ze && ze.isPressed && i("ss", e))
  ...
  function O(e) {
    return (
      (we = e || q()) &&
        ...
        document.body &&
        ((ke = window),
        (Ae = (Me = document).documentElement),
        (Ee = Me.body),
        (t = [ke, Me, Ae, Ee]),
        we.utils.clamp,
        (Ie = "onpointerenter" in Ee ? "pointer" : "mouse"),
        (Ce = S.isTouch =
          ke.matchMedia &&
    ...
    je = {
      ...
      sc: F(function (e) {
        return arguments.length
          ? ke.scrollTo(e, Ge.sc())
          : ke.pageXOffset || Me[n] || Ae[n] || Ee[n] || 0;
      }),
    },
    Ge = {
      s: o,
      ...
      sc: F(function (e) {
        return arguments.length
          ? ke.scrollTo(je.sc(), e)
          : ke.pageYOffset || Me[o] || Ae[o] || Ee[o] || 0;
      }),
    };
  (je.op = Ge), (a.cache = 0);
  var S =
    ((Observer.prototype.init = function init(e) {
      ...
      (this.target = n = I(n) || Ae),
        ...
        (o = !1 !== o),
        (r = r || parseFloat(ke.getComputedStyle(Ee).lineHeight) || 22);
      var ee,
        te,
        re,
        ne,
      ...
      (te = se._dc =
        ...
        (se.enable = function (e) {
          return (
            se.isEnabled ||
              (A(he ? be : n, "scroll", E),
              0 <= t.indexOf("scroll") && A(he ? be : n, "scroll", Ve, s, U),
              0 <= t.indexOf("wheel") && A(n, "wheel", We, s, U),
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed &&
              (se._vx.reset(), se._vy.reset(), B(R ? n : be, De[1], Qe)),
            B(he ? be : n, "scroll", Ve),
            B(n, "wheel", We),
            B(n, De[0], xe),
            B(be, De[2], Se),
  ...
  function Ab() {
    (x = qe.innerWidth), (m = qe.innerHeight);
  }
  function Bb() {
    a.cache++,
      at ||
        ...
        (v &&
          x === qe.innerWidth &&
          !(Math.abs(qe.innerHeight - m) > 0.25 * qe.innerHeight)) ||
        c.restart(!0);
  }
  function Hb(e) {
    var t,
      ...
      i = 0;
    if (_ !== r || ht) {
      for (V(); i < X.length; i += 4)
        (t = qe.matchMedia(X[i]).matches) !== X[i + 3] &&
          ((X[i + 3] = t)
            ? n.push(i)
            : V(1, X[i]) || (Ha(X[i + 2]) && X[i + 2]()));
      for (G(), i = 0; i < n.length; i++)
        (t = n[i]), (dt = X[t]), (X[t + 2] = X[t + 1](e));
      (dt = 0), s && Q(0, 1), (_ = r), j("matchMedia");
    }
  }
  function Ib() {
    return nb(ie, "scrollEnd", Ib) || Q(!0);
  }
  function Nb() {
    return (
      a.cache++ &&
  ...
  function Yb(e, t, r, n) {
    if (e.parentNode !== t) {
      ...
      (a.position = "absolute" === r.position ? "absolute" : "relative"),
        ...
        (s[P] = s[k] = a.flexBasis = "auto"),
        (a.overflow = "visible"),
        (a.boxSizing = "border-box"),
        (a[xt] = gb(e, je) + Pt),
        (a[wt] = gb(e, Ge) + Pt),
        (a[Mt] = s[At] = s.top = s.left = "0"),
        Dt(n),
  ...
  function cc(e, t, r, n, i, o, a, s, l, c, u, f, d) {
    ...
    var p,
      ...
      h,
      b = d ? d.time() : 0;
    if ((d && d.seek(0), Ia(e))) a && Y(a, r, n, !0);
    else {
      Ha(t) && (t = t(s));
      var v,
        m,
    ...
    if (o) {
      ...
      (p = "scroll" + n.d2),
        ...
        u &&
          ((l = Ot(a)),
          u && (o.style[n.op.p] = l[n.op.p] - n.op.m - o._offset + Pt));
    }
    return (
      d &&
        h &&
  ...
  var Je,
    ...
    V = function _revertAll(e, t) {
      var r;
      for (lt = 0; lt < Bt.length; lt++)
        (r = Bt[lt]), (t && r.media !== t) || (e ? r.kill(1) : r.revert());
      t && G(t), t || j("revert");
    },
    U = 0,
      ...
      if (!vt || e) {
        ...
        ct && ie.sort(),
          ...
          Bt.forEach(function (e) {
            return (
              "max" === e.vars.end &&
              e.setPositions(e.start, Ea(e.scroller, e._dir))
            );
          }),
          ...
          (pt = !1),
          j("refresh");
      } else mb(ie, "scrollEnd", Ib);
    },
    Z = 0,
    Lt = 1,
    $ = function _updateAll() {
      if (!pt) {
        gt && gt.update(0), (ie.isUpdating = !0);
        var e = Bt.length,
          t = bt(),
          r = 50 <= t - T,
          n = e && Bt[0].scroll();
        if (
          ...
          (Z = n),
          r &&
            (vt && !st && 200 < t - vt && ((vt = 0), j("scrollEnd")),
            (ot = T),
            (T = t)),
          Lt < 0)
        ) {
    ...
    ie =
      ((ScrollTrigger.prototype.init = function init(_, T) {
        if (
          ...
          var k,
            ...
            Q,
            o,
            Z = (_ = eb(Ga(_) || Ia(_) || _.nodeType ? { trigger: _ } : _, It))
              .onUpdate,
            $ = _.toggleClass,
            a = _.id,
            ee = _.onToggle,
            ...
            we = ve ? 0 : parseFloat(cb(be)["border" + ge.p2 + Et]) || 0,
            Se = this,
            _e =
              _.onRefreshInit &&
              function () {
          ...
          if (
            ...
            Bt.push(Se),
            ce &&
              ((Ja(ce) && !ce.push) || (ce = { snapTo: ce }),
              "scrollBehavior" in rt.style &&
                Je.set(ve ? [rt, tt] : be, { scrollBehavior: "auto" }),
              (p = Ha(ce.snapTo)
                ? ce.snapTo
                : "labels" === ce.snapTo
              ...
              (g = Ja(g) ? it(g.min, g.max) : it(g, g)),
              (G = Je.delayedCall(ce.delay || i / 2 || 0.1, function () {
                var e = Ee(),
                  t = bt() - Ae < 500,
                  r = k.tween;
                if (
                  ...
                  var n = (e - E) / L,
                    ...
                    a = Je.utils.clamp(-n, 1 - n, (yt(o / 2) * o) / 0.185),
            ...
            ie &&
              ...
              (n = Je.core.getCache(ie)).spacer
                ...
                : (l &&
                  ...
                  (n.spacer = N = l || et.createElement("div")),
                  N.classList.add("pin-spacer"),
                  a && N.classList.add("pin-spacer-" + a),
                  (n.pinState = D = _b(ie))),
              (Se.spacer = N = n.spacer),
              (r = cb(ie)),
              (m = r[oe + ge.os2]),
              (R = Je.getProperty(ie)),
              (v = Je.quickSetter(ie, ge.a, Pt)),
              Yb(ie, N, r),
              (H = _b(ie))),
            u)
          ) {
            ...
            (O = this.markerStart = tb("start", a, f, ge, e, t, 0, fe)),
              (C = this.markerEnd = tb("end", a, f, ge, e, t, 0, fe)),
              fe && (Q = Je.quickSetter([O, C], ge.a, Pt)),
              me ||
                (Re.length && !0 === y(be, "fixedMarkers")) ||
                ((function _makePositionable(e) {
                  var t = cb(e).position;
                  e.style.position =
                    "absolute" === t || "fixed" === t ? t : "relative";
                })(ve ? rt : be),
                Je.set([B, z], { force3D: !0 }),
                (x = Je.quickSetter(B, ge.a, Pt)),
                (w = Je.quickSetter(z, ge.a, Pt)));
          }
          if (fe) {
          ...
          (Se.previous = function () {
            ...
            (Se.revert = function (e) {
              ...
              t !== Se.isReverted &&
                (t &&
                  (!Se.scroll.rec && at && pt && (Se.scroll.rec = Ee()),
                  (q = Math.max(Ee(), Se.scroll.rec || 0)),
                  (V = Se.progress),
                  (U = T && T.progress())),
                O &&
                  [O, C, B, z].forEach(function (e) {
                ...
                ie &&
                  (t
                    ...
                    : (ue && Se.isActive) || Yb(ie, N, cb(ie), K)),
                (Se.isReverted = t));
            }),
            (Se.refresh = function (e, t) {
              if ((!at && Se.enabled) || t)
                if (ie && e && vt) mb(ScrollTrigger, "scrollEnd", Ib);
                else {
                  !pt && _e && _e(Se),
                    (at = 1),
                    (Ae = bt()),
                  ...
                  for (
                    Ha(y) && (y = y(Se)),
                      E =
                        cc(y, ne, d, ge, Ee(), O, B, Se, p, we, me, g, fe) ||
                        (ie ? -0.001 : 0),
                      Ha(v) && (v = v(Se)),
                      Ga(v) &&
                        !v.indexOf("+=") &&
                  ...
                  if (
                    ...
                    (r = cb(ie)),
                      ...
                      (c = me && J(be, o ? je : Ge)()),
                      oe &&
                        (((K = [oe + ge.os2, L + b + Pt]).t = N),
                        (S = oe === Mt ? gb(ie, ge) + L + b : 0) &&
                          K.push(ge.d, S + Pt),
                        Dt(K),
                        me && Ee(q)),
                      me &&
                        (((a = {
                          top: n.top + (o ? i - E : c) + Pt,
                          left: n.left + (o ? c : i - E) + Pt,
                          boxSizing: "border-box",
                          position: "fixed",
                        })[xt] = a.maxWidth =
                          Math.ceil(n.width) + Pt),
                        (a[wt] = a.maxHeight = Math.ceil(n.height) + Pt),
                        (a[At] =
                          a[At + Tt] =
                          a[At + St] =
                          a[At + kt] =
                  ...
                  f &&
                    ...
                    Se.revert(!1),
                    G &&
                      ((Me = -1), Se.isActive && Ee(E + L * V), G.restart(!0)),
                    (at = 0),
                    T &&
                      he &&
                      (T._initted || U) &&
                    ...
                    (V === Se.progress && !fe) ||
                      (T && !he && T.totalProgress(V, !0),
                      (Se.progress = V),
                      Se.update(0, 0, 1)),
                    ie && oe && (N._pinOffset = Math.round(Se.progress * F)),
                    te && te(Se);
                }
            }),
              ...
              if (!fe || r || e) {
                ...
                if (
                  ...
                  if (
                    ...
                    if ((e && oe && (N.style[oe + ge.os2] = m), me)) {
                      if (a) {
                        if (
                          ((l =
                            !e && p < d && u < P + 1 && u + 1 >= Ea(be, ge)),
                          ue)
                        )
                          if (e || (!n && !l)) ec(ie, N);
                          else {
                  ...
                  !ce || k.tween || at || ht || G.restart(!0),
                    ...
                    a && !at
                      ? (he &&
                        ...
                        de &&
                          !n &&
                          Math.abs(Se.getVelocity()) > (Ia(de) ? de : 2500) &&
                          (Ma(Se.callbackAnimation),
                          W ? W.progress(1) : Ma(T, !d, 1)))
                      : he && Z && !at && Z(Se);
                }
                if (w) {
                  var b = fe
            ...
            (Se.kill = function (e, t) {
              Se.disable(e, t), W && !t && W.kill(), a && delete zt[a];
              var r = Bt.indexOf(Se);
              0 <= r && Bt.splice(r, 1),
                r === lt && 0 < Lt && lt--,
                (r = 0),
      ...
      (ScrollTrigger.register = function register(e) {
        return (
          s ||
            ((Je = e || za()),
            ya() && window.document && ScrollTrigger.enable(),
            (s = mt)),
          s
        );
      }),
      ...
      (ScrollTrigger.disable = function disable(t, r) {
        (mt = 0),
          ...
          nb(et, "scroll", zb),
          clearInterval(u),
          nb(et, "touchcancel", wa),
          nb(rt, "touchstart", wa),
          lb(nb, et, "pointerdown,touchstart,mousedown", ua),
          lb(nb, et, "pointerup,touchend,mouseup", va),
          c.kill(),
          Fa(nb);
        for (var e = 0; e < a.length; e += 3)
          ob(nb, a[e], a[e + 1]), ob(nb, a[e], a[e + 2]);
      }),
      (ScrollTrigger.enable = function enable() {
        if (
          ...
          Je &&
            ((nt = Je.utils.toArray),
            (it = Je.utils.clamp),
            (ut = Je.core.suppressOverwrites || wa),
            Je.core.globals("ScrollTrigger", ScrollTrigger),
            rt))
        ) {
          (mt = 1),
            S.register(Je),
            (ScrollTrigger.isTouch = S.isTouch),
            mb(qe, "wheel", zb),
            (l = [qe, et, tt, rt]),
          ...
          for (
            r.borderTopStyle = "solid",
              e = Ot(rt),
              Ge.m = Math.round(e.top + Ge.sc()) || 0,
              je.m = Math.round(e.left + je.sc()) || 0,
              n ? (r.borderTopStyle = n) : r.removeProperty("border-top-style"),
              u = setInterval(yb, 250),
              Je.delayedCall(0.5, function () {
                return (ht = 0);
              }),
              mb(et, "touchcancel", wa),
              mb(rt, "touchstart", wa),
              lb(mb, et, "pointerdown,touchstart,mousedown", ua),
              lb(mb, et, "pointerup,touchend,mouseup", va),
              f = Je.utils.checkPrefix("transform"),
              te.push(f),
              s = bt(),
              c = Je.delayedCall(0.2, Q).pause(),
              g = [
                et,
                "visibilitychange",
                function () {
            ...
            ob(nb, a[t], a[t + 1]), ob(nb, a[t], a[t + 2]);
        }
      }),
      (ScrollTrigger.config = function config(e) {
        "limitCallbacks" in e && (ft = !!e.limitCallbacks);
        var t = e.syncInterval;
        (t && clearInterval(u)) || ((u = t) && setInterval(yb, t)),
          "ignoreMobileResize" in e &&
            (v = 1 === ScrollTrigger.isTouch && e.ignoreMobileResize),
          "autoRefreshEvents" in e &&
            (Fa(nb) || Fa(mb, e.autoRefreshEvents || "none"),
      ...
      (ScrollTrigger.scrollerProxy = function scrollerProxy(e, t) {
        var r = I(e),
          ...
          i = Aa(r);
        ~n && a.splice(n, i ? 6 : 2),
          t && (i ? Re.unshift(qe, t, rt, t, tt, t) : Re.unshift(r, t));
      }),
          ...
          (n = X.indexOf(r)),
            ...
            "all" === (dt = r)
              ...
              : (t = qe.matchMedia(r)) &&
                (t.matches && (o = i()),
                ~n
                  ? ((X[n + 1] = La(X[n + 1], i)), (X[n + 2] = La(X[n + 2], o)))
                  : ((n = X.length),
                    X.push(r, i, o),
                    t.addListener
                      ? t.addListener(Hb)
                      : t.addEventListener("change", Hb)),
                (X[n + 3] = t.matches)),
            (dt = 0);
        return X;
      }),
      ...
      (ScrollTrigger.isInViewport = function isInViewport(e, t, r) {
        var n = (Ga(e) ? I(e) : e).getBoundingClientRect(),
          i = n[r ? xt : wt] * t || 0;
        return r
  ...
  (ie.version = "3.10.3"),
    ...
    (ie.refresh = function (e) {
      return e ? Bb() : (s || ie.register()) && Q(!0);
    }),
    (ie.update = $),
    (ie.clearScrollMemory = Nb),
    ...
    (ie.batch = function (e, t) {
      ...
      for (r in t)
        i[r] =
          "on" === r.substr(0, 2) && Ha(t[r]) && "onRefreshInit" !== r
            ? no(0, t[r])
            : t[r];
      return (
        Ha(a) &&
          ((a = a()),
          mb(ie, "refresh", function () {
            return (a = t.batchMax());
          })),
        nt(e).forEach(function (e) {
          var t = {};
  ...
  function ic(e, t) {
    !0 === t
      ...
      : (e.style.touchAction = t ? "pan-" + t : "none"),
      e === tt && ic(rt);
  }
  function kc(e) {
    var t,
    ...
    if (!a._isScrollT || 2e3 < s - a._isScrollT) {
      ...
      (a._isScroll =
        ...
        !Aa(o) &&
        o !== n &&
        (ae[(t = cb(o)).overflowY] || ae[t.overflowX])),
        (a._isScrollT = s);
    }
  ...
  function lc(e, t, r, n) {
    return S.create({
      ...
      onEnable: function onEnable() {
        return r && mb(et, S.eventTypes[0], le, !1, !0);
      },
      onDisable: function onDisable() {
        return nb(et, S.eventTypes[0], le);
      },
    });
  }
  function pc(e) {
    ...
    function ip() {
      (r = Ea(d, Ge)), (x = it(0, r)), u && (y = it(0, Ea(d, je))), (o = U);
    }
    function pp() {
      ip(),
        a.isActive() && a.vars.scrollY > r && a.resetTo("scrollY", Ea(d, Ge));
    }
    Ja(e) || (e = {}),
    ...
    var t,
      ...
      y = wa,
      x = wa,
      w = ie.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent);
    return (
      (e.ignoreCheck = function (e) {
        return (
          (w &&
            "touchmove" === e.type &&
            (function ignoreDrag() {
              if (n) return requestAnimationFrame(fp), !0;
              n = !0;
            })()) ||
          1 < h ||
          t.isGesturing ||
      ...
      (e.onPress = function () {
        var e = h;
        (h = (qe.visualViewport && qe.visualViewport.scale) || 1),
          a.pause(),
          e !== h && ic(d, 1 < h || (!u && "x")),
          (n = !1),
          (s = g()),
        ...
        function (e, t) {
          if (t) {
            var r,
              ...
              i = v();
            u &&
              ((n = (r = g()) + (0.05 * i * -e.velocityX) / 0.227 / h),
              (i *= hc(g, r, n, Ea(d, je))),
              (a.vars.scrollX = y(n))),
              (n = (r = p()) + (0.05 * i * -e.velocityY) / 0.227 / h),
              (i *= hc(p, r, n, Ea(d, Ge))),
              (a.vars.scrollY = x(n)),
      ...
      (e.onChange = function (e, t, r, n, i) {
        U !== o && ip(),
          t &&
            u &&
            g(y(n[2] === t ? s + (e.startX - e.x) / h : g() + t - n[1])),
          r && p(x(i[2] === r ? l + (e.startY - e.y) / h : p() + r - i[1])),
          $();
      }),
      (e.onEnable = function () {
  ...
  var oe,
    ae = { auto: 1, scroll: 1 },
    se = /(input|label|select|textarea)/i,
    le = function _captureInputs(e) {
      var t = se.test(e.target.tagName);
  ...
  (ie.sort = function (e) {
    ...
    (ie.normalizeScroll = function (e) {
      ...
      if (!1 === e) return b && b.kill();
      var t = e instanceof S ? e : pc(e);
      return b && b.target === t.target && b.kill(), Aa(t.target) && (b = t), t;
    }),
    (ie.core = {
      _getVelocityProp: K,
      _inputObserver: lc,
